...
def solve():
    ...
    initial_heur = heuristic_weight * calculate_heuristic(start, exact_dists)
    queue.put((0 + initial_heur, next(counter), start, "")) 
    ...
    while not queue.empty():
        ...
        for m_name, (x, y) in dirs.items():
            ...
            if new_state not in visited:
                ...
                queue.put((f_n, next(counter), new_state, new_path))#, next(counter)
